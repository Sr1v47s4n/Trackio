"""
Django settings for Trackio project.
...
SECRET_KEY = dotenv.get_key(BASE_DIR / ".env", "SECRET_KEY")
...
WSGI_APPLICATION = "Trackio.wsgi.application"
...
DATABASES = {
    ...
    #     "USER": dotenv.get_key(BASE_DIR / ".env", "DB_USER"),
    #     "PASSWORD": dotenv.get_key(BASE_DIR / ".env", "DB_PASSWORD"),
    #     "HOST": dotenv.get_key(BASE_DIR / ".env", "DB_HOST"),
    #     "PORT": dotenv.get_key(BASE_DIR / ".env", "DB_PORT"),
    # }
}
...
EMAIL_HOST = (
    "smtp.gmail.com"  # Replace with your email provider's SMTP server
)
